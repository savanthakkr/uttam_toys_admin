...
class _AgeScreenState extends State<AgeScreen> {
  ...
  List<Age> usermodelList = <Age>[];
  List<Age> filterList = <Age>[];
  ...
  void _sort<T>(Comparable<T> Function(Age d) getField, int columnIndex, bool ascending) {
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      child: Padding(
                          ...
                          child: Text("Add Age",style: GoogleFonts.inter(fontSize: 14.0,fontWeight: FontWeight.w800,color: Colors.white),)))
                ],
              ),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: kDefaultPadding),
                                                ...
                                                onChanged: (value){
                                                  setState(() {
                                                    ...
                                                    filterList = usermodelList.where(
                                                            (area) => area.age.toLowerCase().contains(value!)).toList();
                                                    ...
                                                    _userDataModel = UserDataModel(
                                                      ...
                                                      onDeleteButtonPressed: (Age data) {
                                          ...
                                          child: PaginatedDataTable(
                                            ...
                                            columns: [
                                              ...
                                              DataColumn(label: Text('Category Name'),
                                                  onSort: (int columnIndex, bool ascending) => _sort<String>((Age d) => d.age, columnIndex, ascending)),
  ...
  fetchUser() async {
    ...
    try{
      final AgeModel responseModel = await ApiManager.FetchAgeApi();
      if(responseModel.error == false) {
        setState(() {
          usermodelList = responseModel.age;

          filterList = responseModel.age;
...
class UserDataModel extends DataTableSource {
  ...
  final void Function(Age data) onDeleteButtonPressed;
  final List<Age> usermodelList;
  ...
  void _sort<T> (Comparable<T> Function(Age d) getField,bool ascending){
    usermodelList.sort((Age a, Age b) {
      if (!ascending) {
        final Age c = a;
        a = b;
        b = c;
