...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  List<Category> filterList = <Category>[];
  ...
  void _sort<T>(Comparable<T> Function(Category d) getField, int columnIndex, bool ascending) {
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      child: Padding(
                          ...
                          child: Text("Add Category",style: GoogleFonts.inter(fontSize: 14.0,fontWeight: FontWeight.w800,color: Colors.white),)))
                ],
              ),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: kDefaultPadding),
                                                ...
                                                onChanged: (value){
                                                  setState(() {
                                                    ...
                                                    _userDataModel = UserDataModel(
                                                      ...
                                                      onDeleteButtonPressed: (Category data) {
                                          ...
                                          child: PaginatedDataTable(
                                            ...
                                            columns: [
                                              ...
                                              DataColumn(label: Text('Category Name'),
                                                  onSort: (int columnIndex, bool ascending) => _sort<String>((Category d) => d.name, columnIndex, ascending)),
    ...
    try{
      ...
      if(responseModel.error == false) {
        setState(() {
          ...
          filterList = responseModel.categories;
...
class UserDataModel extends DataTableSource {
  ...
  final void Function(Category data) onDeleteButtonPressed;
  final List<Category> usermodelList;
  ...
  void _sort<T> (Comparable<T> Function(Category d) getField,bool ascending){
    usermodelList.sort((Category a, Category b) {
      if (!ascending) {
        final Category c = a;
        a = b;
        b = c;
