...
class _AddBrandScreenState extends State<AddBrandScreen> {
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: FormBuilderTextField(
                                    ...
                                    validator: FormBuilderValidators.required(errorText: "Please enter Brand Name"),
                                  ),
                                ),
  ...
  void addCategory() async{
    ...
    try {
      final ResultModel resultModel = await ApiManager.AddBrand(
