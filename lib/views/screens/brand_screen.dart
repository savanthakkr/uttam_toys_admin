...
class _BrandScreenState extends State<BrandScreen> {
  ...
  List<Brand> usermodelList = <Brand>[];
  List<Brand> filterList = <Brand>[];
  ...
  void _sort<T>(Comparable<T> Function(Brand d) getField, int columnIndex, bool ascending) {
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      child: Padding(
                          ...
                          child: Text("Add brand",style: GoogleFonts.inter(fontSize: 14.0,fontWeight: FontWeight.w800,color: Colors.white),)))
                ],
              ),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: kDefaultPadding),
                                                ...
                                                onChanged: (value){
                                                  setState(() {
                                                    ...
                                                    _userDataModel = UserDataModel(
                                                      ...
                                                      onDeleteButtonPressed: (Brand data) {
                                          ...
                                          child: PaginatedDataTable(
                                            ...
                                            columns: [
                                              ...
                                              DataColumn(label: Text('Brand Name'),
                                                  onSort: (int columnIndex, bool ascending) => _sort<String>((Brand d) => d.name, columnIndex, ascending)),
  ...
  fetchUser() async {
    ...
    try{
      final BrandModel responseModel = await ApiManager.FetchBrandApi();
      if(responseModel.error == false) {
        setState(() {
          usermodelList = responseModel.brand;

          filterList = responseModel.brand;
...
class UserDataModel extends DataTableSource {
  ...
  final void Function(Brand data) onDeleteButtonPressed;
  final List<Brand> usermodelList;
  ...
  void _sort<T> (Comparable<T> Function(Brand d) getField,bool ascending){
    usermodelList.sort((Brand a, Brand b) {
      if (!ascending) {
        final Brand c = a;
        a = b;
        b = c;
