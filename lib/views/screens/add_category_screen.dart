...
class AddCatgeoryScreen extends StatefulWidget {
   AddCatgeoryScreen({super.key});

  @override
  State<AddCatgeoryScreen> createState() => _AddCatgeoryScreenState();
}

class _AddCatgeoryScreenState extends State<AddCatgeoryScreen> {
  ...
  void addCategory() async{
    ...
    try {
      final ResultModel resultModel = await ApiManager.AddCategory(
