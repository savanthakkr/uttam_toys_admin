...
import 'package:uttam_toys/master_layout_config.dart';
import 'package:uttam_toys/providers/app_preferences_provider.dart';
import 'package:uttam_toys/providers/user_data_provider.dart';
import 'package:uttam_toys/sub_admin_config.dart';
import 'package:uttam_toys/theme/theme_extensions/app_sidebar_theme.dart';
...
class Sidebar extends StatefulWidget {
  ...
  final void Function() onThemeButtonPressed;
...
class _SidebarState extends State<Sidebar> {
  ...
  _getDataAsync() async {
    ...
    setState(() {
      _isAdmin = userDataProvider.isAdmin;
    });
                ...
                child: ListView(
                  ...
                  children: [
                    SidebarHeader(
                      ...
                      onThemeButtonPressed: widget.onThemeButtonPressed,
                    ),
                    Padding(
  ...
  Widget _sidebarMenuList(BuildContext context) {
    ...
    return Column(
      children: _isAdmin == "0" ? sidebarMenuConfigs.map<Widget>((menu) {
      ...
      }).toList(growable: false) : subadminconfig.map<Widget>((menu) {
        if (menu.children.isEmpty) {
          return _sidebarMenu(
            context,
            EdgeInsets.fromLTRB(
              ...
              builder: (context, value, child) {
                return Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      CircleAvatar(
                        backgroundImage: Image.asset("assets/images/login_icon.png",height: 40.0,width: 40.0,).image,
                        backgroundColor: Colors.white,
                      ),
